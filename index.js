...
const requoteIfNeeded = (market) => {
    ...
    // requote if more than time_to_requote passes
    const lastQuoteTime = lastQuoteTimes[market] || Date.now();
    if (Date.now() - lastQuoteTime > PARAMS[market].time_to_requote) {
